...
export default function Hero() {
    return (
        <section className="bg-white min-h-[65vh] flex items-end relative justify-center overflow-hidden">
            <img src={"/designer.jpg"} className="absolute -top-20" alt="" />
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 z-10">
                ...
                <p className="mb-8 text-lg font-normal lg:text-xl sm:px-16 xl:px-48 400">Here at Flowbite we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
            </div>
        </section>
